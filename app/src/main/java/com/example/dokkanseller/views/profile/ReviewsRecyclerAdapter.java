...
public class ReviewsRecyclerAdapter extends RecyclerView.Adapter<ReviewsRecyclerAdapter.ReviewViewHolder>{
    ...
    ArrayList<ProfileReviewModel> reviewList;

    public ReviewsRecyclerAdapter(ArrayList<ProfileReviewModel> chatList) {
    ...
    public ReviewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_profile_review, null, false);
